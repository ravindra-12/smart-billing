    ...
    <main style={{ minHeight: "100vh", background: "#f6f9ff" }}>
      ...
      <section style={{ maxWidth: 1280, margin: "0 auto", padding: "20px 20px 40px" }}>
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          {businessTypeLoading ? (
            <>
              <div style={{ height: 40, width: "80%", maxWidth: 400, borderRadius: 12, background: "linear-gradient(90deg, #f1f5f9 25%, #e2e8f0 50%, #f1f5f9 75%)", backgroundSize: "200% 100%", animation: "shimmer 1.4s infinite", margin: "0 auto 12px" }} />
              <div style={{ height: 20, width: "90%", maxWidth: 560, borderRadius: 8, background: "linear-gradient(90deg, #f1f5f9 25%, #e2e8f0 50%, #f1f5f9 75%)", backgroundSize: "200% 100%", animation: "shimmer 1.4s infinite", margin: "0 auto" }} />
            </>
          ) : (
            <>
              <h2 className="rt-section" style={{ fontWeight: 900, color: "#0f172a", margin: "0 0 10px" }}>
      ...
      <section style={{ maxWidth: 1280, margin: "0 auto", padding: "20px 20px 40px" }}>
        <div style={{
          ...
          <div style={{ textAlign: "center", marginBottom: 36 }}>
            {whyChooseLoading ? (
              <>
                <div style={{ height: 40, width: "80%", maxWidth: 440, borderRadius: 12, background: "linear-gradient(90deg, #f1f5f9 25%, #e2e8f0 50%, #f1f5f9 75%)", backgroundSize: "200% 100%", animation: "shimmer 1.4s infinite", margin: "0 auto 12px" }} />
                <div style={{ height: 20, width: "90%", maxWidth: 520, borderRadius: 8, background: "linear-gradient(90deg, #f1f5f9 25%, #e2e8f0 50%, #f1f5f9 75%)", backgroundSize: "200% 100%", animation: "shimmer 1.4s infinite", margin: "0 auto" }} />
              </>
            ) : (
              <>
                <h2 className="rt-section" style={{ fontWeight: 900, color: "#0f172a", margin: "0 0 10px" }}>
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#f6f9ff" }}>
      <section style={{ maxWidth: 1280, margin: "0 auto", padding: "60px 20px 30px", textAlign: "center" }}>
        ...
        <h1 className="rt-pricing-hero" style={{ fontWeight: 900, color: "#0f172a", margin: "0 0 16px" }}>{pricingHero.title}</h1>
        <p style={{ fontSize: 16, color: "#475569", maxWidth: 560, margin: "0 auto 50px", lineHeight: 1.7 }}>
      ...
      <section style={{ maxWidth: 1280, margin: "0 auto", padding: "0 20px 30px" }}>
        ...
        <div className="rg-trust" style={{ marginTop: 24, background: "#fff", borderRadius: 24, padding: 16, border: "1px solid #f1f5f9" }}>
      ...
      <section style={{ maxWidth: 1280, margin: "0 auto", padding: "20px 20px" }}>
        <div style={{ background: "#fff", borderRadius: 32, padding: 40, boxShadow: "0 4px 20px rgba(0,0,0,0.06)", border: "1px solid #f1f5f9" }}>
          <div style={{ textAlign: "center", marginBottom: 36 }}>
            <h2 className="rt-section" style={{ fontWeight: 900, color: "#0f172a", margin: "0 0 10px" }}>{pricingSteps.heading}</h2>
      ...
      <section style={{ maxWidth: 1280, margin: "0 auto", padding: "0 20px 60px" }}>
        <div style={{ background: "linear-gradient(135deg, #1d4ed8 0%, #7c3aed 100%)", borderRadius: 32, padding: "40px 24px" }}>
          <div className="rg-cta-inner">
            <div>
              <h2 className="rt-cta" style={{ fontWeight: 900, color: "#fff", margin: "0 0 12px" }}>{pricingBottom.ctaHeading}</h2>
    ...
    <main style={{ minHeight: "100vh", background: "#f6f9ff" }}>
      <section style={{ background: "linear-gradient(135deg, #1e40af 0%, #4338ca 50%, #7c3aed 100%)", padding: "60px 20px" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <div className="rg-features-hero">
          <div>
            ...
            <h1 className="rt-features-hero" style={{ fontWeight: 900, color: "#fff", lineHeight: 1.1, margin: "0 0 20px" }}>{featureHero.title}</h1>
            <p style={{ fontSize: 15, color: "#bfdbfe", lineHeight: 1.7, maxWidth: 480, marginBottom: 28 }}>
              {featureHero.description}
            </p>
            <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
              <Link href="#download-apk" onClick={scrollToDownload} style={{ background: "#fff", color: "#1d4ed8", border: "none", borderRadius: 14, padding: "14px 24px", fontWeight: 900, fontSize: 14, cursor: "pointer", textDecoration: "none" }}>
                {featureHero.primaryButtonText}
              </Link>
              <Link href="#download-apk" onClick={scrollToDownload} style={{ background: "rgba(255,255,255,0.1)", color: "#fff", border: "1px solid rgba(255,255,255,0.3)", borderRadius: 14, padding: "14px 24px", fontWeight: 900, fontSize: 14, cursor: "pointer", textDecoration: "none" }}>
      ...
      {featuresGroups.map(group => (
        <section key={group.title} style={{ maxWidth: 1280, margin: "0 auto", padding: "24px 20px 0" }}>
          <div style={{ background: "#fff", borderRadius: 28, padding: "24px 20px", boxShadow: "0 4px 20px rgba(0,0,0,0.06)", border: "1px solid #f1f5f9" }}>
            <div style={{ display: "inline-flex", borderRadius: 14, padding: "10px 20px", fontSize: 15, fontWeight: 900, marginBottom: 24, background: group.tone === "green" ? "#dcfce7" : group.tone === "blue" ? "#dbeafe" : "#ede9fe", color: group.tone === "green" ? "#15803d" : group.tone === "blue" ? "#1d4ed8" : "#6d28d9" }}>{group.title}</div>
            <div className="rg-feature-cards">
      ...
      <section style={{ maxWidth: 1280, margin: "0 auto", padding: "24px 20px" }}>
        <div style={{ background: "linear-gradient(135deg, #0f172a 0%, #1e3a5f 100%)", borderRadius: 28, padding: 32, color: "#fff" }}>
          <h2 className="rt-section" style={{ fontWeight: 900, margin: "0 0 10px" }}>{hardwareContent.heading}</h2>
          <p style={{ color: "#93c5fd", marginBottom: 28, fontSize: 14 }}>{hardwareContent.subheading}</p>
          <div className="rg-hardware">
